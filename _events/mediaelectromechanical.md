...
Второе занятие состоится в этот четверг (13.02.2020), в 19:00. Будем подключать к ардуине разное: датчики расстояния, акселерометры, тензодатчики, сервоприводы, шаговики, адресные ленты.
