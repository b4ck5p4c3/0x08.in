    ...
    <article>
      ...
      <section>
        <p>
          ...
          Вместе мы разбираемся в сложных вещах, делаем эвенты, работаем над проектами и
      ...
      <section>
        ...
        <p>
          Бэкспейс – не закрытый клуб. Если вы разделяете наши принципы и хотите делать его вместе – <a href='https://wiki.bksp.in/s/public/doc/roli-i-uchastie-EiakNMstP1'>присоединяйтесь</a>.
        </p>
      </section>
      <section>
        <header>
        ...
        <ol className='list-spaced'>
          <li>
            ...
            <p>Прислушивайся к мнению и потребностям других.</p>
          </li>
          <li>
          ...
          <li>
            ...
            <p>Бэкспейс не является источником прибыли, а финансовый вклад не влияет на принятие решений.</p>
          </li>
          <li>
            <b>Do-ocracy.</b>
          ...
          <li>
            ...
            <p>Safety first. Заботься о безопасности себя и окружающих.</p>
          </li>
        </ol>
